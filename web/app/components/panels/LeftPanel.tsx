    ...
    <>
              ...
              {isCreating && !sidebarCollapsed && (
                <div className="p-2 bg-cyan-50 border border-cyan-200 rounded-xl">
                  <input
                    ...
                    className="w-full px-2 py-1.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  />
                </div>
              )}
                        ...
                        {isEditing ? (
                          <div className="flex-1 flex items-center gap-2">
                            <input
                              ...
                              className="flex-1 px-2 py-1 text-sm border border-cyan-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                            />
                            <button
      ...
      {contextMenuId && (
        <div
          ...
          className="fixed z-50 bg-white border border-slate-200 rounded-xl shadow-lg py-1 min-w-[140px]"
        >
          <button
            onClick={() => {
